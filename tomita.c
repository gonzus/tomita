...
static unsigned VertE;
static unsigned VertP;

static struct RRed* REDS;
static unsigned RP;
static unsigned RE;

static struct ERed* EREDS;
static unsigned EP;
static unsigned EE;

static struct Path* PathTab;
static unsigned PathE;
...
static unsigned AddSub(Symbol L, struct Subnode* P) {
...
static void AddLink(struct ZNode* Z, struct Subnode* P) {
...
static void Reduce1(struct ZNode* Z, Symbol L, Rule R) {
