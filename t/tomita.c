...
static void test_tomita_build_and_parse_ok(void) {
  ...
  do {
    ...
    errors = tomita_compile_grammar_from_slice(tomita, g);
    ...
    struct Node* node = tomita_parse_slice_into_forest(tomita, e);
